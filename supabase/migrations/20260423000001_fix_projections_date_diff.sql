-- Fix get_client_projections function to handle year calculation robustly
-- Specifically fixing huge numbers in days_between_orders due to year 0026 vs 2026
